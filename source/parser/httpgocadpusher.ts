...
export class HttpGocadPusherParser extends Parser {
   static WORKER_NAME = "gocadhttppusher.js";
   ...
   public parse(data: any): Promise<any> {
      return new Promise<any>((resolve, reject) => {
         let worker = new Worker(this.getWorkersBase() + HttpGocadPusherParser.WORKER_NAME);
